...
export var disclaimer = 'Los abajo firmantes, como colindantes del predio objeto de levantamiento ' +
        ...
        'procedimiento realizado por el topógrafo, y estan de acuerdo con los linderos señalados ' +
        'durante este procedimiento.';


export const gratciculeIntervals = [0.1, 0.05, 0.01, 0.005, 0.003, 0.001];